...
export default function Header() {
    return (
        <div id="home" className='flex lg:items-start justify-between px-16 lg:mt-40 mt-20 flex-col lg:flex-row items-center text-center lg:text-left'>
            <div>
                <h1 className="font-normal lg:text-5xl text-4xl text-gray-450 leading-[56px]">We Serve <br /> Marine Industry</h1>
                <hr className="mt-4 w-36 bg-gray-450 h-[3px] mx-auto lg:mx-0" />
                <p className="lg:text-2xl my-5 text-gray-450 font-normal">Your Trusted Partner For <br /> Electrical & Instrumentation, Structural, <br /> Cruise Outfitting</p>
