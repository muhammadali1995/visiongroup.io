...
export default function Header() {
  return (
    <div
      id="home"
      className={
        "flex lg:items-start justify-between px-16 lg:pt-40 pt-20 flex-col lg:flex-row items-center text-center lg:text-left "
      }
    >
      <div>
        <h1 className="font-normal lg:text-5xl sm:text-4xl text-3xl leading-[56px]">
          We're <br className="hidden sm:block" /> Your{" "}
          <span className="font-bold"> Software Engineering</span> Department
        </h1>
        <hr className="mt-4 w-36 bg-gray-450 h-[3px] mx-auto lg:mx-0" />
        <p className="lg:text-2xl my-5 font-normal">
          Your Trusted Partner For
          <br className="hidden sm:block" />
          <span className="font-bold">Web, Mobile, Desktop,</span>
          <br className="hidden sm:block" />
      ...
      <div>
        <Image
          ...
          width={100}
          height={100}
          src="/images/main-theme-yellow.svg"
          className="lg:-mt-14 w-[808px] h-[490px] lg:-mr-36"
          alt="header"
        />
      </div>
    </div>
