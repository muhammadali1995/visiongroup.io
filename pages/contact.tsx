...
function ContactCard({ cardTitle, cardCreator, cardCompany, isDarkMode }: any) {
  return (
    <div
      className={
        "w-full cursor-pointer mx-auto max-w-[405px] " +
        (isDarkMode ? "bg-gray-450 text-white" : "bg-white text-gray-450")
      }
      style={{ filter: "drop-shadow(4px 8px 8px rgba(0,0,0,.08))" }}
    >
      <div className="py-2 px-4">
        <div className="flex items-start">
          <h3 className="text-5xl w-16 text-blue-450 ml-2">&#8216;&#8216;</h3>
          <h3 className="font-normal text-xl mt-8 ml-4 capitalize max-w-[232px] leading-[36px]">
            {cardTitle}
          </h3>
        </div>
        <div className="flex items-center mt-14 pb-4">
          <div
            className={
              "mr-4 p-4 rounded-full font-bold text-xl " +
              (isDarkMode
                ? "text-white bg-black"
                : "bg-[#d9d9d9] text-gray-450")
            }
          >
...
export default function Contact() {
  ...
  return (
    <div
      className={
        "lg:px-16 sm:mt-20 mt-10 py-8 " +
        (isDarkMode ? "bg-gray-450 text-white" : "bg-[#ebeced] text-gray-450")
      }
      id="contact"
    >
